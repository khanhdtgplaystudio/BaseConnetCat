...
public class ConfigBuild
{
    ...
    private static string KeyStorePath = "Assets/01_RedAndBlue/KeyStore/cmd_h2.keystore";

    private const string folderPath = "CountMaster_Final";
...
PlayerSettings.Android.targetArchitectures = aac;
    ...
    {
        string localPath = "Assets/01_NFT_Game/Scenes/LoadingScene.unity";
    ...
    {
        string localPath = "Assets/01_NFT_Game/Scenes/HomeScene.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    ...
    {
        string localPath = "Assets/01_NFT_Game/Scenes/GamePlay.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
}
